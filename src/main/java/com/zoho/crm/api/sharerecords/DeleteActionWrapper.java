...
public class DeleteActionWrapper implements Model, DeleteActionHandler
{
	 ...
	 */
	public DeleteActionResponse getShare()
	{
		return  this.share;
	 ...
	 */
	public void setShare(DeleteActionResponse share)
	{
		 this.share=share;
