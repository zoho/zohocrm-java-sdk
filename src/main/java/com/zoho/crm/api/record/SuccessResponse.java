...
public class SuccessResponse implements Model, ActionResponse, FileHandler
{
	...
	/**
	 * The method to get the value of duplicateField
	 * @return A String representing the duplicateField
	 */
	...
	public void setDuplicateField(String duplicateField)
	{
		 ...
		 this.keyModified.put("duplicate_field", 1);
	 ...
	 * @return An instance of Choice<String>
	 */
	public Choice<String> getAction()
	{
		return  this.action;
	 ...
	 */
	public void setAction(Choice<String> action)
	{
		 this.action=action;
