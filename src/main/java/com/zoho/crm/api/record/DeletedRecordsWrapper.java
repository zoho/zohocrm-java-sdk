...
public class DeletedRecordsWrapper implements Model, DeletedRecordsHandler
{
	 ...
	 * @return An instance of List<DeletedRecord>
	 */
	 ...
	 * @param data An instance of List<DeletedRecord>
	 */
