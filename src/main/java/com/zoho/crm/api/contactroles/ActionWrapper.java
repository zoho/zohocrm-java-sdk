...
public class ActionWrapper implements Model, ActionHandler
{
	 ...
	 */
	public List<ActionResponse> getContactRoles()
	{
	 ...
	 * @param contactRoles An instance of List<ActionResponse>
	 */
	public void setContactRoles(List<ActionResponse> contactRoles)
	{
